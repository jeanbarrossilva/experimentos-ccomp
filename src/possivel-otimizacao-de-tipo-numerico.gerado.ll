; ModuleID = 'src/possivel-otimizacao-de-tipo-numerico.gerado.c'
source_filename = "src/possivel-otimizacao-de-tipo-numerico.gerado.c"
...
entry:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef 2.000000e+00)
  ret i32 0
}
...
!5 = !{!"Apple clang version 21.0.0 (https://github.com/swiftlang/llvm-project.git 0f0f486e411bf9cfdea42f0c3617f50f70764ab4)"}
